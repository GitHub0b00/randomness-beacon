...
def main(opt_restart, opt_new_keypair):
    ...
    # Generate Private Key and Public Key. (It should pack into function in the future for clarity of this program code.)
    if opt_new_keypair == 'new':
    ...
    for _ in range(numberofpulses):
        ...
        tt = str(t).replace(' ', 'T')[:-15] + '00.' + '000Z'  # Modification Oct. 28th.
...
if __name__ == "__main__":
    ...
    opt_new_keypair = ''
    while opt_new_keypair != 'new' and opt_new_keypair != 'continue':
        opt_new_keypair = input('Please decide if we hope to generate new public and private keys, type new to generate one new key pair, type continue to continue using the previous key pair:\n')
    
    main(opt_restart, opt_new_keypair)
